...
def _build_style_guidance(example_letter: str | None) -> str:
    ...
    return (
        ...
        "Replicate its tone, vocabulary level, paragraph structure, and approximate length — "
...
async def generate_cover_letter(
    ...
    task = Task(
        description=(
            ...
            "2. MANDATORY: explicitly name the target company and role from the TARGET JOB "
            "section in the opening paragraph.\n"
            "3. MANDATORY: naturally weave in at least 3 of the hard skills listed in "
            "the TARGET JOB section.\n"
            "4. MANDATORY: transform the 'Tailored highlights' bullets into 1–2 concrete "
