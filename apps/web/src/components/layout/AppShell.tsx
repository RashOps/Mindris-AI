...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <aside
        className="fixed inset-y-0 left-0 z-40 hidden border-r border-slate-200 bg-white px-4 py-5 lg:block"
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4 rounded-lg border border-slate-200 bg-slate-50 p-3">
