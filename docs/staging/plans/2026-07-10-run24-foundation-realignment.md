...
- [x] T1: Lock the theme bootstrap and semantic token contract
...
- [x] T2: Normalize high-traffic tool surfaces onto shared theme states
...
- [x] T3: Add focused regression coverage for theme switching and readability
...
- [x] T4: Re-baseline product-facing guidance after the theme pass
