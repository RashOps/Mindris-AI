...
- [x] T3: Builder/dashboard community template flows
...
- [x] T4: Renderer package CSS safety and preview parity
...
- [x] T5: CI and browser QA hardening for multilingual and template flows
