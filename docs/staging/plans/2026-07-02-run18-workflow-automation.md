...
- [x] T1: Opportunity workflow backend contract
...
- [x] T2: Workflow persistence and API
...
- [x] T3: History and lineage integration
...
- [x] T5: Phase validation and closure
